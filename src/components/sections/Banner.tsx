export default function Banner() {
  return (
    <main className="[background:_linear-gradient(0deg,_rgba(0,0,0,0.85)_0%,_rgba(255,255,255,0)_100%)] w-full h-[calc(100vh-3rem)] [backdrop-filter:_blur(1.5px)] flex justify-start items-center overflow-hidden z-10">
