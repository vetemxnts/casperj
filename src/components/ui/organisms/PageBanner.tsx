...
export default function PageBanner() {
	return (
		<main className='[background:_radial-gradient(circle,rgba(56,189,248,0.5)_0%,rgba(0,0,0,0.5)_100%)] w-full h-[calc(100svh-3rem+2px)] [backdrop-filter:_blur(1.5px)] overflow-hidden z-10'>
